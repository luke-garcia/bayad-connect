...
public final class PrimeWater extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    EditText field_accountno,field_amountdue,field_passon,field_accountname,field_billno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prime_water);
        ...
        field_billno = (EditText) findViewById(R.id.field_billno);
        ...
        if(field_accountno.getText().toString().isEmpty()){
            ...
            if(field_amountdue.getText().toString().isEmpty()){
                ...
                if(Double.parseDouble(field_amountdue.getText().toString()) <= 35000.00){
                    ...
                    }else if(field_billno.getText().toString().isEmpty()){
    ...
    public void connectToAPI_Validation(){
        ...
        PrimeWater primeWater = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName,primeWater);
    ...
    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_accname)+field_accountname.getText().toString()+getString(R.string.te_accname)+
                getString(R.string.ts_billno)+field_billno.getText().toString()+getString(R.string.te_billno);
