...
public final class LagunaWaterDistrictAquatechInc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laguna_water_district_aquatech_inc);
    ...
    public void connectToAPI_Validation(){
        ...
        LagunaWaterDistrictAquatechInc activity = this;
