...
public final class Maynilad extends AppCompatActivity {
    ...
    ImageView image;
    String sServiceCode,sBillerCode,sWallet,sTpaid,apireturn,sAccountno, sAmountdue, sPasson, sAmounttopay,sBillName,sOtherInfo;
    int iImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maynilad);
    ...
    public void connectToAPI_Validation(){
        ...
        sOtherInfo = "none";
        Maynilad maynilad = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName,maynilad);
