...
public final class IsabelaIIElectricCooperative extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    public EditText field_accountno,field_amountdue,field_passon,field_consumername,field_duedate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_isabela_ii_electric_cooperative);
    ...
    public void connectToAPI_Validation(){
        ...
        IsabelaIIElectricCooperative activity = this;
    ...
    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_duedate)+field_duedate.getText().toString()+getString(R.string.te_duedate)+
                getString(R.string.ts_consumername)+field_consumername.getText().toString()+getString(R.string.te_consumername);
        return sOtherInfo;
    }
