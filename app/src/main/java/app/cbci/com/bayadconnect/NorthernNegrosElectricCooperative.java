...
public final class NorthernNegrosElectricCooperative extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    public EditText field_accountno,field_amountdue,field_passon,field_accountname,field_duedate,field_billmonth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_northern_negros_electric_cooperative);
    ...
    public void connectToAPI_Validation(){
        ...
        NorthernNegrosElectricCooperative activity = this;
