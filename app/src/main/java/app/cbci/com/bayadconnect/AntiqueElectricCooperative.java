...
public final class AntiqueElectricCooperative extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    EditText field_accountno,field_amountdue,field_passon,field_accountname,field_duedate,field_billmonth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_antique_electric_cooperative);
    ...
    public void connectToAPI_Validation(){
        ...
        AntiqueElectricCooperative activity = this;
