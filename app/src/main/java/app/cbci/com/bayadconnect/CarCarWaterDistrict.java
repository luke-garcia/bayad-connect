...
public final class CarCarWaterDistrict extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    public EditText field_accountno,field_amountdue,field_passon,field_accountname,field_duedate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_car_car_water_district);
    ...
    public void connectToAPI_Validation(){
        ...
        CarCarWaterDistrict activity = this;
