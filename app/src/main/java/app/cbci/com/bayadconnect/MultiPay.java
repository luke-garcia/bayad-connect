...
public final class MultiPay extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    public EditText field_referenceno,field_amountdue,field_passon,field_accountname,field_contactno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle(data.getString("billername"));
        ...
        spinner_bill = (Spinner) findViewById(R.id.spinner_biller);
    ...
    public void validate() {
        ...
        if(field_referenceno.getText().toString().isEmpty() ){
            ...
            if(field_contactno.getText().toString().length() > 12){
                showMessage(getString(R.string.error_multipaycontact));
            }else if(field_amountdue.getText().toString().isEmpty()){
    ...
    public void connectToAPI_Validation(){
        ...
        MultiPay multiPay = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName,multiPay);
    }

    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_contactnumber)+field_contactno.getText().toString()+getString(R.string.te_contactnumber)+
                    getString(R.string.ts_affiliate)+sBillName+getString(R.string.te_affiliate);
        return sOtherInfo;
    }
