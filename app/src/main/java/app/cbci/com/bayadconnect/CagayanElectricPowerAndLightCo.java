...
public final class CagayanElectricPowerAndLightCo extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    public EditText field_accountno,field_amountdue,field_passon,field_contactno;
    TextView text_Total,text_wallet,text_duedate;
    ImageView image;
    String payfor,sServiceCode,sBillerCode,sWallet,sTpaid,apireturn,sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName;
    int iImage;
    Double amountdue,passon,total;
    ProgressDialog progressDialog;
    SharedPreferences preferences;
    Spinner spinner_payfor;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cagayan_electric_power_and_light_co);
        ...
        spinner_payfor = (Spinner) findViewById(R.id.spinner_payfor);
        ...
        spinner_payfor.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                switch (spinner_payfor.getSelectedItem().toString()){
    ...
    public void connectToAPI_Validation(){
        ...
        CagayanElectricPowerAndLightCo activity = this;
    ...
    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_contactnumber)+field_contactno.getText().toString()+getString(R.string.te_contactnumber)+
                getString(R.string.ts_payfor)+payfor+getString(R.string.te_payfor);
        return sOtherInfo;
    }
