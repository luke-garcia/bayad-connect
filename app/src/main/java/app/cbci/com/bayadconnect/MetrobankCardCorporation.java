...
public final class MetrobankCardCorporation extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    EditText field_accountno,field_amountdue,field_passon,field_consumername;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_metrobank_card_corporation);
    ...
    public void connectToAPI_Validation(){
        ...
        MetrobankCardCorporation metrobank = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName,metrobank);

    }


    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_consname)+field_consumername.getText().toString()+getString(R.string.te_consname);
