...
public final class SSSOFW extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    EditText field_accountno,field_amountdue,field_passon,field_firstname,field_lastname,field_flexifund;
    TextView text_Total,text_wallet,text_srn;
    ImageView image;
    String sServiceCode,sBillerCode,sWallet,sTpaid,apireturn,sAccountno,sFlexiFund, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName;
    ...
    Spinner spinner_sssamount,spinner_dateto_month,spinner_dateto_year,spinner_datefrom_month,spinner_datefrom_year;
    SharedPreferences preferences;
    LinearLayout linear_employer,linear_ecamount,linear_flexifund,linear_date,linear_name;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sssofw);
    ...
    private void connectToAPI_Validation(){
        ...
        SSSOFW sssofw = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName,sssofw);
    ...
    private String OtherInfo(){
        sOtherInfo = getString(R.string.ts_paytype)+"O"+getString(R.string.te_paytype)+
    ...
    private void computeAmountDue(){
        ...
        try {
            ...
            fm = Integer.parseInt(sDateFromMonth);
            fy = Integer.parseInt(sDateFromYear);
            tm = Integer.parseInt(sDateToMonth);
            ty = Integer.parseInt(sDateToYear);
