...
public final class CarmonaWaterDisrict extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carmona_water_disrict);
    ...
    public void connectToAPI_Validation(){
        ...
        CarmonaWaterDisrict activity = this;
