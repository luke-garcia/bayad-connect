...
public final class DragonPay extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    EditText field_referenceno,field_amountdue,field_passon,field_lastname,field_firstname,field_contactno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dragon_pay);
    ...
    public void validate() {
        ...
        if(field_referenceno.getText().toString().isEmpty()){
        ...
        }else if(field_referenceno.getText().toString().length() == 8){
                ...
                if(Double.parseDouble(field_amountdue.getText().toString()) <= 35000.00){
                    ...
                    if(field_firstname.getText().toString().isEmpty()){
                        ...
                        if(field_lastname.getText().toString().isEmpty()){
                            ...
                            }else if(field_contactno.getText().toString().length()>=7 && field_contactno.getText().toString().length()<=12){
                                connectToAPI_Validation();
                            }else{
                                showMessage(getString(R.string.error_contactnumber_712length));
                            }
                        }
                    }
            ...
            showMessage(getString(R.string.error_acc8digits));
        }
    ...
    public void connectToAPI_Validation(){
        ...
        DragonPay dragonPay = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName,dragonPay);
