...
public final class DasmarinasCityWaterDistrict extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    public EditText field_accountno,field_amountdue,field_passon,field_name,field_duedate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dasmarinas_city_water_district);
    ...
    public void connectToAPI_Validation(){
        ...
        DasmarinasCityWaterDistrict activity = this;
