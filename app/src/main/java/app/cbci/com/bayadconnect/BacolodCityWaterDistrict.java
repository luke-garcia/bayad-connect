...
public final class BacolodCityWaterDistrict extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    public EditText field_accountno,field_amountdue,field_passon,field_accountname,field_meternumber,field_duedate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bacolod_city_water_district);
    ...
    public void connectToAPI_Validation(){
        ...
        BacolodCityWaterDistrict activity = this;
    ...
    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_meterno)+field_meternumber.getText().toString()+getString(R.string.te_meterno)+
