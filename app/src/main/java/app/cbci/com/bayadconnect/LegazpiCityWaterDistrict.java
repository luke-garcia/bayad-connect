...
public final class LegazpiCityWaterDistrict extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    public EditText field_accountno,field_amountdue,field_passon,field_billmonth,field_accountname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_legazpi_city_water_district);
    ...
    public void connectToAPI_Validation(){
        ...
        LegazpiCityWaterDistrict activity = this;
