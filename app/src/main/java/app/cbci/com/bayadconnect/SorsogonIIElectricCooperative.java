...
public final class SorsogonIIElectricCooperative extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sorsogon_ii_electric_cooperative);
    ...
    public void connectToAPI_Validation(){
        ...
        SorsogonIIElectricCooperative activity = this;
