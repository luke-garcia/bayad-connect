...
public final class LagunaWater extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    EditText field_accountno,field_amountdue,field_passon,field_duedate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laguna_water);
    ...
    public void validate() {
        ...
        }else if(field_accountno.getText().toString().length() == 8){
    ...
    public void connectToAPI_Validation(){
        ...
        LagunaWater lagunaWater = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName,lagunaWater);
