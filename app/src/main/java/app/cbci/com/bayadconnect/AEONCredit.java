...
public final class AEONCredit extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    EditText field_agreementno,field_amountdue,field_passon,field_accountname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aeoncredit);
        ...
        field_agreementno = (EditText) findViewById(R.id.field_agreementno);
    ...
    public void validate() {
        ...
        if(field_agreementno.getText().toString().isEmpty()){

            showMessage(getString(R.string.error_agreementnumber));

        }else if(field_agreementno.getText().toString().length() == 10){

            if(field_accountname.getText().toString().isEmpty()){
                showMessage(getString(R.string.error_accountname));
            }else {
            ...
            showMessage(getString(R.string.error_agreement10digits));
        }
    ...
    public void connectToAPI_Validation(){
        sAccountno = field_agreementno.getText().toString();
        ...
        AEONCredit aeonCredit = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName,aeonCredit);
    }
