...
public final class TagaytayCityWaterDistrict extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    public EditText field_accountno,field_amountdue,field_passon,field_customername,field_beforedue,field_duedate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tagaytay_city_water_district);
        ...
        field_customername = (EditText) findViewById(R.id.field_customername);
        field_beforedue = (EditText) findViewById(R.id.field_beforedue);
    ...
    public void connectToAPI_Validation(){
        ...
        TagaytayCityWaterDistrict activity = this;
    ...
    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_accname)+field_customername.getText().toString()+getString(R.string.te_accname)+
                getString(R.string.ts_duedate)+field_duedate.getText().toString()+getString(R.string.te_duedate)+
                getString(R.string.ts_billamount)+field_amountdue.getText().toString()+getString(R.string.te_billamount)+
                getString(R.string.ts_beforedue)+field_beforedue.getText().toString()+getString(R.string.te_beforedue);
        return sOtherInfo;
    }
