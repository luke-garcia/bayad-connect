...
public final class SanJoseDelMonteWaterDistrict extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    EditText field_accountno,field_amountdue,field_passon,field_accountname,field_duedate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_san_jose_del_monte_water_district);
    ...
    public void validate() {
        ...
        if(field_accountno.getText().toString().isEmpty()){
        ...
        }else if(field_accountno.getText().toString().length() <= 13){
            ...
            if(field_amountdue.getText().toString().isEmpty()){
                ...
                if(Double.parseDouble(field_amountdue.getText().toString()) <= 35000.00){
                    ...
                    }else if(field_duedate.getText().toString().isEmpty()){
            ...
            showMessage(getString(R.string.error_acc13digits));
        }
    ...
    public void connectToAPI_Validation(){
        ...
        SanJoseDelMonteWaterDistrict sanJoseDelMonteWaterDistrict = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName,sanJoseDelMonteWaterDistrict);
