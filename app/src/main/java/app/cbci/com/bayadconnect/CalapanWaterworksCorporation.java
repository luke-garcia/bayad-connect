...
public final class CalapanWaterworksCorporation extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    public EditText field_accountno,field_amountdue,field_passon,field_customername;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calapan_waterworks_corporation);
    ...
    public void connectToAPI_Validation(){
        ...
        CalapanWaterworksCorporation activity = this;
    ...
    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_customername)+field_customername.getText().toString()+getString(R.string.te_customername);
        return sOtherInfo;
    }
