...
public final class IlocosNorteElectricCooperative extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    EditText field_accountno,field_amountdue,field_passon,field_duedate,field_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ilocos_norte_electric_cooperative);
        ...
        field_name.addTextChangedListener(checkName);
    ...
    public void connectToAPI_Validation(){
        ...
        IlocosNorteElectricCooperative ilocosNorteElectricCooperative = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName,ilocosNorteElectricCooperative);
    ...
    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_duedate)+field_duedate.getText().toString()+getString(R.string.te_duedate)+
                getString(R.string.ts_name)+field_name.getText().toString()+getString(R.string.te_name);
