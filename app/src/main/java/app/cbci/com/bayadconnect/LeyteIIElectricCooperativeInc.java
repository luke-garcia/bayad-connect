...
public final class LeyteIIElectricCooperativeInc extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    EditText field_accountno,field_amountdue,field_passon,field_contactno,field_duedate,field_billmonth,field_firstname,field_lastname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leyte_iielectric_cooperative_inc);
        ...
        field_billmonth.setText(new Functions(this).YearMonth());
    ...
    public void connectToAPI_Validation(){
        ...
        LeyteIIElectricCooperativeInc leyteIIElectricCooperativeInc = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName,leyteIIElectricCooperativeInc);
    ...
    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_duedate)+field_duedate.getText().toString()+getString(R.string.te_duedate)+
                ...
                getString(R.string.ts_contactnumber)+field_contactno.getText().toString()+getString(R.string.te_contactnumber);
