...
public final class MMDA extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    public EditText field_accountno,field_amountdue,field_passon,field_name;
    Spinner spinner_violationcode, spinner_clearancefee;
    TextView text_Total,text_wallet,text_duedate;
    ImageView image;
    String sClearanceFee,sViolationCode,sServiceCode,sBillerCode,sWallet,sTpaid,apireturn,sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName;
    int iImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mmda);
        ...
        spinner_clearancefee = (Spinner) findViewById(R.id.spinner_clearancefee);
        spinner_violationcode = (Spinner) findViewById(R.id.spinner_violationcode);
        ...
        spinner_clearancefee.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                sClearanceFee = spinner_clearancefee.getSelectedItem().toString();
                switch (sClearanceFee){
                    case "30 Pesos Additional Fee":
                        sClearanceFee = "1";
                        break;
                    case "No Clearance Fee":
                        sClearanceFee = "0";
                        break;
                }
            }
        ...
        spinner_violationcode.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                sViolationCode = spinner_violationcode.getSelectedItem().toString();
                int posOfSeparator = sViolationCode.indexOf("|");
                sViolationCode = sViolationCode.substring(0,posOfSeparator);
            }
    ...
    public void validate() {
        ...
        }else if(!field_accountno.getText().toString().isEmpty()){
    ...
    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_name)+field_name.getText().toString()+getString(R.string.te_name)+
                getString(R.string.ts_violationcode)+sViolationCode+getString(R.string.te_violationcode)+
                getString(R.string.ts_clearancefee)+sClearanceFee+getString(R.string.te_clearancefee);
        return sOtherInfo;
    }
