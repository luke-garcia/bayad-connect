...
public final class AboitizPower extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    EditText field_accountno,field_amountdue,field_passon,field_lastname,field_firstname;
    TextView text_Total,text_wallet,text_srn,text_telephone;
    ImageView image;
    String sServiceCode,sBillerCode,sWallet,sTpaid,apireturn,sPowerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName;
    int iImage;
    Double amountdue,passon,total;
    ProgressDialog progressDialog;
    Spinner spinner_powercompany;
    SharedPreferences preferences;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_aboitiz_power);
        ...
        spinner_powercompany = (Spinner) findViewById(R.id.spinner_powercompany);
        ...
        spinner_powercompany.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {

                switch (spinner_powercompany.getSelectedItem().toString()){
                    case "Cotabato Light and Power Co":
                        sPowerCode = "CLPC";
                        break;
                    case "Subic Enerzone Corp":
                        sPowerCode = "SEZ";
                        break;
                    case "Mactan Enerzone Corp":
                        sPowerCode = "MEZ";
                        break;
                    case "Balamban Enerzone Corp":
                        sPowerCode = "BEZ";
                        break;
    ...
    public void connectToAPI_Validation(){
        ...
        AboitizPower aboitizPower = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, OtherInfo(), sBillName,aboitizPower);
    }
    ...
    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_fname)+field_firstname.getText().toString()+getString(R.string.te_fname)+
                ...
                getString(R.string.ts_powercom)+sPowerCode+getString(R.string.te_powercom);
        return sOtherInfo;
    }
