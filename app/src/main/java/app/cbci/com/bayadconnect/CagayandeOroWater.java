...
public final class CagayandeOroWater extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    public EditText field_accountno,field_amountdue,field_passon,field_accountname,field_win,field_duedate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cagayande_oro_water);
        ...
        field_win = (EditText) findViewById(R.id.field_win);
    ...
    public void connectToAPI_Validation(){
        ...
        CagayandeOroWater activity = this;
    ...
    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_win)+field_win.getText().toString()+getString(R.string.te_win)+
