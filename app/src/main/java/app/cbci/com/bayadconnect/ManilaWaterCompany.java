...
public final class ManilaWaterCompany extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    EditText field_accountno,field_amountdue,field_passon;
    TextView text_Total,text_wallet;
    ImageView image;
    String sServiceCode,sBillerCode,sWallet,sTpaid,apireturn,sOtherInfo,sAccountno,sAmountdue,sPasson,sAmounttopay,sBillName;
    int iImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manila_water_company);
    ...
    public void validate() {
        ...
        if(field_accountno.getText().toString().isEmpty()){
            ...
            if(field_accountno.getText().toString().length() == 8){
                ...
                if(field_amountdue.getText().toString().isEmpty()){
                    ...
                    if(Double.parseDouble(field_amountdue.getText().toString()) >= 20.00){
                        ...
                        showMessage(getString(R.string.error_mwcomamountdue));
                    }
    ...
    public void connectToAPI_Validation(){
        ...
        sOtherInfo = "none";
        ManilaWaterCompany manila = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName,manila);
