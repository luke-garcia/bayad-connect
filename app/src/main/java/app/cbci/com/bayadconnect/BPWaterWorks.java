...
public final class BPWaterWorks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bpwater_works);
    ...
    public void connectToAPI_Validation(){
        ...
        BPWaterWorks bpWaterWorks = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, OtherInfo(), sBillName,bpWaterWorks);
    }
