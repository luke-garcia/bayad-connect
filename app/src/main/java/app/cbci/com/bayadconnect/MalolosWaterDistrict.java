...
public final class MalolosWaterDistrict extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_malolos_water_district);
    ...
    public void connectToAPI_Validation(){
        ...
        MalolosWaterDistrict activity = this;
