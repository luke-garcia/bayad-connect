...
public final class NuevaEcijaIIElectricCooperative extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    public EditText field_accountno,field_amountdue,field_passon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nueva_ecija_ii_electric_cooperative);
    ...
    public void connectToAPI_Validation(){
        ...
        NuevaEcijaIIElectricCooperative activity = this;
