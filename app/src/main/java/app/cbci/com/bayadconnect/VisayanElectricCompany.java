...
public final class VisayanElectricCompany extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visayan_electric_company);
    ...
    public void connectToAPI_Validation(){
        ...
        VisayanElectricCompany visayanElectricCompany = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName,visayanElectricCompany);
