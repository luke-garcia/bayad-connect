...
public final class ABSCBNMobile extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    public EditText field_accountno,field_amountdue,field_passon,field_phoneno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_abscbnmobile);
    ...
    public void connectToAPI_Validation(){
        ...
        ABSCBNMobile abscbnMobile = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName,abscbnMobile);
    }

    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_phoneno)+field_phoneno.getText().toString()+getString(R.string.te_phoneno);
        return sOtherInfo;
    }
