...
public final class AngelesElectricCorporation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_angeles_electric_corporation);
    ...
    public void connectToAPI_Validation(){
        ...
        AngelesElectricCorporation activity = this;
    ...
    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_customername)+field_accountname.getText().toString()+getString(R.string.te_customername)+
                getString(R.string.ts_duedate)+field_billdate.getText().toString()+getString(R.string.te_duedate);
