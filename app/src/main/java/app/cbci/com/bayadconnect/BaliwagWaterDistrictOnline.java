...
public final class BaliwagWaterDistrictOnline extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baliwag_water_district_online);
    ...
    public void connectToAPI_Validation(){
        ...
        BaliwagWaterDistrictOnline activity = this;
