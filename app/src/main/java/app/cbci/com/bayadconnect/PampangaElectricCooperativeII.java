...
public final class PampangaElectricCooperativeII extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    EditText field_accountno,field_amountdue,field_passon,field_consumername,field_duedate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pampanga_electric_cooperative_ii);
    ...
    public void connectToAPI_Validation(){
        ...
        PampangaElectricCooperativeII pampangaElectricCooperativeII = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName,pampangaElectricCooperativeII);
