...
public final class MeycauayanWaterDistrict extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    EditText field_accountno,field_amountdue,field_passon,field_contactno,field_duedate,field_billnumber,field_firstname,field_lastname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meycauayan_water_district);
        ...
        Toast.makeText(getApplicationContext(), sServiceCode, Toast.LENGTH_LONG).show();
    }
    ...
    public void validate() {
        ...
        }else if(field_accountno.getText().toString().length() <=15){
    ...
    public void connectToAPI_Validation(){
        ...
        MeycauayanWaterDistrict meycauayanWaterDistrict = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName,meycauayanWaterDistrict);
    ...
    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_duedate)+field_duedate.getText().toString()+getString(R.string.te_duedate)+
                getString(R.string.ts_billno)+field_billnumber.getText().toString()+getString(R.string.te_billno)+
