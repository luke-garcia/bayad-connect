...
public final class CagayanIElectricCooperative extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    public EditText field_accountno,field_amountdue,field_passon,field_contactno,field_billingperiod,field_duedate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cagayan_i_electric_cooperative);
        ...
        field_billingperiod = (EditText) findViewById(R.id.field_billingperiod);
        ...
        field_billingperiod.setText(new Functions(this).MonthSlashYear());
    ...
    public void connectToAPI_Validation(){
        ...
        CagayanIElectricCooperative activity = this;
    ...
    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_contactnumber)+field_contactno.getText().toString()+getString(R.string.te_contactnumber)+
                ...
                getString(R.string.ts_billingperiod)+field_billingperiod.getText().toString()+getString(R.string.te_billingperiod);
        return sOtherInfo;
    }
