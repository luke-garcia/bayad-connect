...
public final class BatelecI extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    EditText field_accountno,field_amountdue,field_passon,field_consumername,field_duedate,field_billmonth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_batelec_i);
                    ...
                    if(field_consumername.getText().toString().isEmpty()){
                        ...
                        if(field_duedate.getText().toString().isEmpty()){
                            ...
                            if(field_billmonth.getText().toString().isEmpty()){
                                showMessage(getString(R.string.error_billmonth));
                            }else if(new Functions(this).checkMonthSlashYear(field_billmonth.getText().toString())){
    ...
    public void connectToAPI_Validation(){
        ...
        BatelecI batelecI = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName,batelecI);
