...
public final class SilangWaterDistrict extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    public EditText field_accountno,field_amountdue,field_passon,field_billno,field_duedate;
    ...
    Spinner spinner_billmonth;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_silang_water_district);
        ...
        spinner_billmonth = (Spinner) findViewById(R.id.spinner_billmonth);
    ...
    public void connectToAPI_Validation(){
        ...
        SilangWaterDistrict activity = this;
    ...
    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_billno)+field_billno.getText().toString()+getString(R.string.te_billno)+
                getString(R.string.ts_duedate)+field_duedate.getText().toString()+getString(R.string.te_duedate)+
                getString(R.string.ts_billmonth)+spinner_billmonth.getSelectedItem().toString()+getString(R.string.te_billmonth);
        return sOtherInfo;
    }
