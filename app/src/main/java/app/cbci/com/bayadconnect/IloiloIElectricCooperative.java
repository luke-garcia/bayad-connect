...
public final class IloiloIElectricCooperative extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    EditText field_accountno,field_amountdue,field_passon,field_duedate,field_consumerid,field_firstname,field_lastname,field_billnumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iloilo_ielectric_cooperative);
        ...
        field_consumerid = (EditText) findViewById(R.id.field_consumerid);
        field_firstname = (EditText) findViewById(R.id.field_firstname);
        field_lastname = (EditText) findViewById(R.id.field_lastname);
        field_billnumber = (EditText) findViewById(R.id.field_billnumber);
                    ...
                    if(field_duedate.getText().toString().isEmpty()){
                        ...
                        if(field_firstname.getText().toString().isEmpty()){
                            ...
                            if(field_lastname.getText().toString().isEmpty()){
                                ...
                                if(field_consumerid.getText().toString().isEmpty()){
                                    showMessage(getString(R.string.error_consumerid));
                                }else {
                                    if(field_billnumber.getText().toString().isEmpty()){
                                        showMessage(getString(R.string.error_billno));
                                    }else {
    ...
    public void connectToAPI_Validation(){
        ...
        if(sAccountno.length()==8){
            sAccountno = field_accountno.getText().toString().subSequence(0,2)+"-"+field_accountno.getText().toString().subSequence(2,6)+"-"+field_accountno.getText().toString().subSequence(6,8);
         //   Toast.makeText(this,sAccountno,Toast.LENGTH_LONG).show();
        }
        ...
        IloiloIElectricCooperative iloiloIElectricCooperative = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName,iloiloIElectricCooperative);
    ...
    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_duedate)+field_duedate.getText().toString()+getString(R.string.te_duedate)+
                getString(R.string.ts_consumerid)+field_consumerid.getText().toString()+getString(R.string.te_consumerid)+
                getString(R.string.ts_billnumber)+field_billnumber.getText().toString()+getString(R.string.te_billnumber)+
