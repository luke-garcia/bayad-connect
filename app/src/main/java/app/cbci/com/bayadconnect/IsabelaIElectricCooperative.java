...
public final class IsabelaIElectricCooperative extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    public EditText field_accountno,field_amountdue,field_passon,field_consumername,field_duedate,field_date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_isabela_i_electric_cooperative);
        ...
        field_date.setText(new Functions(this).MonthSlashYear());
    ...
    public void connectToAPI_Validation(){
        ...
        IsabelaIElectricCooperative activity = this;
    ...
    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_consumername)+field_consumername.getText().toString()+getString(R.string.te_consumername)+
                ...
                getString(R.string.ts_billmonth)+field_date.getText().toString()+getString(R.string.te_billmonth);
        return sOtherInfo;
    }
