...
public final class ECensus extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    EditText field_referenceno,field_amountdue,field_passon,field_accountname,field_contactno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecensus);
    ...
    public void validate() {
        ...
        if(field_referenceno.getText().toString().isEmpty()){
        ...
        }else if(field_referenceno.getText().toString().length() == 16){
            ...
            showMessage(getString(R.string.error_acc16digits));
        }
    ...
    public void connectToAPI_Validation(){
        ...
        ECensus eCensus = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName,eCensus);

    }

    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_payorname)+field_accountname.getText().toString()+getString(R.string.te_payorname)+
