...
public final class LaUnionElectricCooperative extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    public EditText field_accountno,field_amountdue,field_passon,field_duedate,field_billnumber,field_accountname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_la_union_electric_cooperative);
    ...
    public void connectToAPI_Validation(){
        ...
        LaUnionElectricCooperative activity = this;
