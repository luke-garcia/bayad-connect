...
public final class CableLink extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    EditText field_accountno,field_amountdue,field_passon,field_accountname,field_contactno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cable_link);
   ...
   public void validate() {
        ...
        }else if(field_accountno.getText().toString().length() == 9){
            ...
            if(field_amountdue.getText().toString().isEmpty()){
                ...
                if(Double.parseDouble(field_amountdue.getText().toString()) <= 35000.00){
                    if(field_accountname.getText().toString().isEmpty()){
                        ...
                        }else if(field_contactno.getText().toString().length() >=7 || field_contactno.getText().toString().length() <=11 ){
                            connectToAPI_Validation();
                        }else{
                            showMessage(getString(R.string.error_contactnumber_711length));
                        }
                    }
                }else{
    ...
    public void connectToAPI_Validation(){
        ...
        CableLink cable = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName,cable);
