...
public final class TagumWaterDistrict extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    public EditText field_accountno,field_amountdue,field_passon,field_customername,field_duedate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tagum_water_district);
    ...
    public void connectToAPI_Validation(){
        ...
        TagumWaterDistrict activity = this;
    ...
    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_name)+field_customername.getText().toString()+getString(R.string.te_name)+
