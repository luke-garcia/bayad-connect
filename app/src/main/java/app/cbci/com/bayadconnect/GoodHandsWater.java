...
public final class GoodHandsWater extends AppCompatActivity {

    DecimalFormat decimalFormat = new DecimalFormat("##,##0.00");
    Button button_submit;
    EditText field_accountno,field_amountdue,field_passon,field_accountname,field_duedate,field_disconnectiondate;
    TextView text_Total,text_wallet,text_srn,text_telephone;
    ImageView image;
    String sServiceCode,sBillerCode,sWallet,sTpaid,apireturn,sTypeCode, sAccountno, sAmountdue, sPasson, sAmounttopay, sOtherInfo, sBillName;
    int iImage;
    Double amountdue,passon,total;
    ProgressDialog progressDialog;
    Spinner spinner_bpwwi;
    SharedPreferences preferences;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_good_hands_water);
        ...
        field_disconnectiondate = (EditText) findViewById(R.id.field_disconnectiondate);
        ...
        spinner_bpwwi = (Spinner) findViewById(R.id.spinner_bpwwi);
        ...
        field_disconnectiondate.setText(new Functions(this).CommonDate());
        ...
        spinner_bpwwi.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {

                switch (spinner_bpwwi.getSelectedItem().toString()){
                    case "Water Bills":
                        sTypeCode = "Service1";
                        break;
                    case "Miscellaneous":
    ...
    public void connectToAPI_Validation(){
        ...
        GoodHandsWater goodHandsWater = this;
        new Functions(this).connectToAPI_Validation(sTpaid, sWallet, sServiceCode, sBillerCode, sAccountno, sAmountdue, sPasson, sAmounttopay, OtherInfo(), sBillName,goodHandsWater);
    }
    ...
    public String OtherInfo(){
        sOtherInfo = getString(R.string.ts_accname)+field_accountname.getText().toString()+getString(R.string.te_accname)+
                ...
                getString(R.string.ts_typecode)+sTypeCode+getString(R.string.te_typecode)+
                getString(R.string.ts_disconnectiondate)+field_disconnectiondate.getText().toString()+getString(R.string.te_disconnectiondate);
        return sOtherInfo;
    }
